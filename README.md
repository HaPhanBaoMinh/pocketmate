...
Trạng thái ngày 13/09/2026: bo đã xác định là LCDWiki 2.8inch ESP32-S3 Display (N16R8, ILI9341V). Firmware bản thử ANCS đã chạy trên bo, hiển thị trạng thái và mã ghép nối lên LCD; đang chờ ghép nối iPhone thật để xem Google Maps gửi gì qua thông báo.
